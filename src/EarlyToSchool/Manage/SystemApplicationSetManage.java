		...
		public static String GetSystemApplicationSetList() {
			...
			while (table.hasNext()) {
				...
				Data += "{\"Id\":'" + dbObj.get("_id") + "',\"ApplicationCode\":'" + dbObj.get("ApplicationCode") + 
						"',\"ApplicationName\":'" + dbObj.get("ApplicationName") + "'," + "\"ApplicationIcon\":'" + dbObj.get("ApplicationIcon") + 
						"',\"ApplicationGrade\":'" + dbObj.get("ApplicationGrade") + "'," + "\"ApplicationURL\":'" + dbObj.get("ApplicationURL") +
						"',\"ApplicationPosition\":'" + dbObj.get("ApplicationPosition") + "',\"DeleteFlag\":'" + dbObj.get("DeleteFlag") + "'},";
			}
			table = null;
			if(Data == "["){
				return "";
